...
public final class CipherUtils {
     ...
     * MD5加密
     */
    private static String keyString="ShiPengYan";
    ...
    public static String decrypt(String data, String algorithm)
        ...
        Cipher cipher = Cipher.getInstance(algorithm);
        cipher.init(Cipher.DECRYPT_MODE, getDESKey(keyString.getBytes()));
        String result = new String(cipher.doFinal(StringUtils
                .hexStringToByteArray(data)), "utf8");
        return result;
    }
...
//    StringUtils.byteArrayToHexString(cipher.doFinal(data
//            .getBytes("utf8")))
    /**
    ...
    public static String encrypt(String data)
            throws Exception {
        Cipher cipher = Cipher.getInstance("DES");
        cipher.init(Cipher.ENCRYPT_MODE, getDESKey(keyString.getBytes()));
        return StringUtils.byteArrayToHexString(cipher.doFinal(data
                .getBytes("utf8")));
    }
}